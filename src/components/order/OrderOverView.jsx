          ...
          <div className={"w-3/4 mx-auto pt-6"}>
            ...
            <TableContainer component={Paper}>
              <Table sx={{ minWidth: 700 }} aria-label="customized table">
                ...
                <TableBody>
                  {currentOrderRows.map((order_row) => (
                    <StyledTableRow key={order_row.order_row_id}>
                      <StyledTableCell
                        component="th"
                        scope="row"
                        align="center"
          ...
          <div className={"mx-auto w-1/3"}>
            ...
            <TableContainer component={Paper}>
              <Table className={"w-1/3"} aria-label="customized table">
                ...
                <TableBody>
                  {currentOrderDetails.snackTotals.map((snackTotal) => (
                    <StyledTableRow key={snackTotal.naam}>
                      <StyledTableCell
                        component="th"
                        scope="row"
                        align="center"
          ...
          <div className={"mx-auto w-1/3"}>
            ...
            <TableContainer component={Paper}>
              <Table className={"w-1/3"} aria-label="customized table">
                ...
                <TableBody>
                  {currentOrderDetails.payments.map((payment) => (
                    <StyledTableRow key={payment.user_name}>
                      <StyledTableCell
                        component="th"
                        scope="row"
                        align="center"
